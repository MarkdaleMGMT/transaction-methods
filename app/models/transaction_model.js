...
async function new_get_account_transactions(account_id){
  let query = (
    ...
    SELECT
      ...
      t.exchange_rate,
      if(t.account_type = "credit", t.amount * t.exchange_rate * -1, t.amount * t.exchange_rate) as amount_cad,
      if(t.account_type = "credit", @runtot * t.exchange_rate * -1, @runtot * t.exchange_rate) as
        amount_balance_cad,
      custom_memo
    FROM transaction t
