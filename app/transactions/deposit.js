 ...
 */
 ...
 async function deposit(username,amount,datetime){
   ...
   try{
    ...
    let debit_query_with_vals = build_insert_transaction('clam_mine','debit', amount, 'admin', datetime, 'deposit', 'deposit');
    let credit_query_with_vals = build_insert_transaction(username,'credit', amount*-1, 'admin', datetime, 'deposit', 'deposit');
